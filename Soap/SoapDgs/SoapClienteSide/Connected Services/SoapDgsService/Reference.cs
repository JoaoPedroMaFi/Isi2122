...
namespace SoapDgsService
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Infectado", Namespace="http://schemas.datacontract.org/2004/07/SoapDgs.Models")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SoapDgsService.IClient")]
    public interface IClient
    {
        ...
        System.Threading.Tasks.Task<SoapDgsService.Infectado> GetAsync();
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<SoapDgsService.Infectado>> GetAllAsync(int idPerson);
        ...
        System.Threading.Tasks.Task IndicateInfetionAsync(string firstName, string lastName, int idEquipa);
        ...
        System.Threading.Tasks.Task IndicateInfetionListAsync(System.Collections.Generic.List<SoapDgsService.Infectado> list);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public interface IClientChannel : SoapDgsService.IClient, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3-preview3.21351.2")]
    public partial class ClientClient : System.ServiceModel.ClientBase<SoapDgsService.IClient>, SoapDgsService.IClient
    {
        ...
        public System.Threading.Tasks.Task<SoapDgsService.Infectado> GetAsync()
        {
            return base.Channel.GetAsync();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<SoapDgsService.Infectado>> GetAllAsync(int idPerson)
        {
            return base.Channel.GetAllAsync(idPerson);
        }
        
        public System.Threading.Tasks.Task IndicateInfetionAsync(string firstName, string lastName, int idEquipa)
        {
            return base.Channel.IndicateInfetionAsync(firstName, lastName, idEquipa);
        }
        
        public System.Threading.Tasks.Task IndicateInfetionListAsync(System.Collections.Generic.List<SoapDgsService.Infectado> list)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IClient))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:59245/Sevices/Client.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
